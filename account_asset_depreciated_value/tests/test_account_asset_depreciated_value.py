...
class TestAccountAssetDepreciatedValue(common.TransactionCase):
    ...
    def test_account_asset_example_01(self):
        self.assertEqual(self.asset_01.method_time, 'percentage')
        self.assertEqual(self.asset_01.annual_percentage, 33)
        self.assertEqual(self.asset_01.method_period, 'month')
        self.assertEqual(self.asset_01.method, 'linear')
        self.assertTrue(self.asset_01.prorata)
        ...
        self.assertEqual(round(first_line.amount, 2), 14.87)
        ...
        self.assertEqual(round(prelast_line.remaining_value, 2), 10.04)
        ...
        self.assertEqual(round(last_line.amount, 2), 10.04)
        ...
        self.assertEqual(round(self.asset_01.value_depreciated, 2), 14.87)
    ...
    def test_account_asset_example_02(self):
        ...
        self.assertEqual(prelast_line.line_date, self.to_date('20250831'))
        self.assertEqual(prelast_line.line_days, 31)
        self.assertEqual(round(prelast_line.depreciated_value, 2), 636.43)
        self.assertEqual(prelast_line.amount, 18.29)
