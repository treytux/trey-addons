...
class TestSaleStockProductPack(TransactionCase):
    ...
    def test_product_packs_standard_prices(self):
        self.assertEqual(self.product_tmp_1.standard_price, 50)
        self.assertEqual(self.product_tmpl_2.standard_price, 100)
        self.assertEqual(self.product_tmpl_3.standard_price, 150)
        self.assertEqual(self.product_pack_totalized.standard_price, 250)
        ...
        self.assertEqual(self.product_pack_totalized.standard_price, 300)
        self.product_tmp_1.standard_price = 50
        self.product_pack_totalized.pack_line_ids = False
        self.assertEqual(self.product_pack_totalized.standard_price, 250)
        self.assertEqual(self.product_pack_detailed.standard_price, 500)
        ...
        self.assertEqual(self.product_pack_detailed.standard_price, 500)
        self.assertEqual(self.product_pack_ignored.standard_price, 750)
    ...
    def test_sale_product_pack_detailed(self):
        ...
        for line in sale.order_line:
            line.product_id = line.product_id  # trigger onchange
            self.assertEqual(
                line.purchase_price, line.product_id.standard_price)
        self.assertEqual(len(sale.order_line), 3)
        self.assertEqual(sale.margin, 1700)
    ...
    def test_sale_product_pack_ignored(self):
        ...
        self.assertEqual(sale.order_line[0].purchase_price, 750)
        ...
        self.assertEqual(len(sale.order_line), 3)
        self.assertEqual(sale.margin, 2600)
    ...
    def test_sale_product_pack_totalized(self):
        ...
        self.assertEqual(self.product_tmpl_2.standard_price, 100)
        self.assertEqual(self.product_tmpl_3.standard_price, 150)
        self.assertEqual(self.product_pack_totalized.standard_price, 400)
        ...
        self.assertEqual(sale.order_line[0].purchase_price, 250)
        for line in sale.order_line.filtered('pack_parent_line_id'):
            line.product_id = line.product_id
            self.assertEqual(line.purchase_price, 0.0)
        self.assertEqual(len(sale.order_line), 3)
        self.assertEqual(sale.margin, 2900)
