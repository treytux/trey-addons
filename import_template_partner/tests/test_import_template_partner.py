...
class TestImportTemplatePartner(TransactionCase):
    ...
    def setUp(self):
        ...
        self.env['sale.invoicing.grouping.criteria'].create({
            'name': 'By partner',
            'field_ids': [(6, 0, [partner_id_field.id])],
        })
    ...
    def test_import_create_base_ok(self):
        ...
        self.assertEqual(wizard.total_rows, 5)
        ...
        self.assertEqual(len(partners_1), 0)
        partners_1_1 = self.env['res.partner'].search([
            ('name', '=', 'Contact 1'),
        ])
        self.assertEqual(len(partners_1_1), 0)
        partners_1_2 = self.env['res.partner'].search([
            ('name', '=', 'Invoice address'),
        ])
        self.assertEqual(len(partners_1_2), 0)
        partners_2 = self.env['res.partner'].search([
            ('name', '=', 'Customer 2'),
        ])
        self.assertEqual(len(partners_2), 0)
        agent_1 = self.env['res.partner'].search([
            ('name', '=', 'Agent 1'),
        ])
        self.assertEqual(len(agent_1), 0)
        ...
        self.assertEqual(len(partners_1), 1)
        self.assertEqual(partners_1.company_type, 'company')
        self.assertEqual(partners_1.comercial, 'Customer Engine')
        self.assertEqual(partners_1.vat, 'ESA00000000')
        self.assertFalse(partners_1.parent_id.exists())
        self.assertEqual(partners_1.type, False)
        self.assertEqual(partners_1.street, 'Real, 33')
        self.assertEqual(partners_1.street2, 'Building 4')
        self.assertEqual(partners_1.city, 'Armilla')
        self.assertFalse(partners_1.city_id.exists())
        self.assertEqual(partners_1.state_id.name, 'Granada')
        self.assertFalse(partners_1.zip_id.exists())
        self.assertEqual(partners_1.country_id.name, 'Spain')
        self.assertEqual(partners_1.phone, '958958958')
        self.assertEqual(partners_1.mobile, '666555666')
        self.assertEqual(partners_1.email, 'customer@test.es')
        self.assertEqual(partners_1.website, 'http://www.customer.es')
        self.assertEqual(len(partners_1.category_id), 0)
        self.assertIn('Notes from tests.', partners_1.comment)
        self.assertEqual(partners_1.agent, False)
        self.assertEqual(partners_1.agent_type, 'agent')
        self.assertEqual(partners_1.settlement, 'monthly')
        self.assertEqual(partners_1.user_id.name, 'Mitchell Admin')
        self.assertFalse(
            partners_1.sale_invoicing_grouping_criteria_id.exists())
        self.assertEqual(partners_1.ref, 'Ref 1')
        partners_1_1 = self.env['res.partner'].search([
            ('name', '=', 'Contact 1'),
            ('parent_id', '=', partners_1.id),
        ])
        self.assertEqual(len(partners_1_1), 1)
        self.assertEqual(partners_1_1.type, 'contact')
        partners_1_2 = self.env['res.partner'].search([
            ('name', '=', 'Invoice address'),
            ('parent_id', '=', partners_1.id),
        ])
        self.assertEqual(len(partners_1_2), 1)
        self.assertEqual(partners_1_2.type, 'invoice')
        self.assertEqual(partners_1_2.street, 'Sun, 100')
        partners_2 = self.env['res.partner'].search([
            ('name', '=', 'Customer 2'),
        ])
        self.assertEqual(len(partners_2), 1)
        self.assertEqual(partners_2.company_type, 'company')
        self.assertEqual(partners_2.comercial, '')
        self.assertFalse(partners_2.vat)
        self.assertFalse(partners_2.parent_id.exists())
        self.assertEqual(partners_2.type, False)
        self.assertEqual(partners_2.street, 'Moon, 2')
        self.assertEqual(partners_2.street2, '')
        self.assertEqual(partners_2.city, 'Brussels')
        self.assertEqual(partners_2.city_id.name, 'Brussels')
        self.assertFalse(partners_2.state_id)
        self.assertEqual(partners_2.zip_id.name, '1000')
        self.assertEqual(partners_2.country_id.name, 'Belgium')
        self.assertEqual(partners_2.phone, '')
        self.assertEqual(partners_2.mobile, '')
        self.assertEqual(partners_2.email, '')
        self.assertEqual(partners_2.website, '')
        self.assertEqual(len(partners_2.category_id), 0)
        self.assertEqual(partners_2.comment, '')
        self.assertEqual(partners_2.agent, False)
        self.assertEqual(partners_2.agent_type, 'agent')
        self.assertEqual(partners_2.settlement, 'monthly')
        self.assertFalse(partners_2.user_id)
        self.assertFalse(
            partners_2.sale_invoicing_grouping_criteria_id.exists())
        self.assertEqual(partners_2.ref, '')
        agent_1 = self.env['res.partner'].search([
            ('name', '=', 'Agent 1'),
        ])
        self.assertEqual(len(agent_1), 1)
        self.assertEqual(agent_1.company_type, 'company')
        self.assertEqual(agent_1.comercial, '')
        self.assertFalse(agent_1.vat)
        self.assertFalse(agent_1.parent_id.exists())
        self.assertEqual(agent_1.type, False)
        self.assertEqual(agent_1.street, 'Moon, 2')
        self.assertEqual(agent_1.street2, '')
        self.assertEqual(agent_1.city, 'Brussels')
        self.assertEqual(agent_1.city_id.name, 'Brussels')
        self.assertFalse(agent_1.state_id)
        self.assertEqual(agent_1.zip_id.name, '1000')
        self.assertEqual(agent_1.country_id.name, 'Belgium')
        self.assertEqual(agent_1.phone, '')
        self.assertEqual(agent_1.mobile, '')
        self.assertEqual(agent_1.email, '')
        self.assertEqual(agent_1.website, '')
        self.assertEqual(len(agent_1.category_id), 0)
        self.assertEqual(agent_1.comment, '')
        self.assertEqual(agent_1.agent, True)
        self.assertEqual(agent_1.agent_type, 'agent')
        self.assertEqual(agent_1.settlement, 'annual')
        self.assertFalse(agent_1.user_id)
        self.assertEqual(agent_1.ref, '')
    ...
    def test_import_create_with_category_id(self):
        ...
        self.assertEqual(len(partners_3), 0)
        wizard.action_import_from_simulation()
        self.assertEqual(wizard.total_rows, 5)
        ...
        self.assertEqual(partners_1.email, 'customer@test.es')
        self.assertEqual(partners_1.website, 'http://www.customer.es')
        self.assertEqual(len(partners_1.category_id), 2)
        self.assertEqual(partners_1.category_id[0].name, 'Partner categ 1')
        self.assertEqual(partners_1.category_id[1].name, 'Partner categ 2')
        self.assertIn('Notes from tests.', partners_1.comment)
        self.assertEqual(partners_1.agent, False)
        self.assertEqual(partners_1.agent_type, 'agent')
        self.assertEqual(partners_1.settlement, 'monthly')
        ...
        self.assertEqual(len(partners_3), 1)
        self.assertEqual(partners_3.company_type, 'company')
        self.assertEqual(partners_3.comercial, '')
        self.assertFalse(partners_3.vat)
        self.assertFalse(partners_3.parent_id.exists())
        self.assertEqual(partners_3.type, False)
        self.assertEqual(partners_3.street, 'Moon, 3')
        self.assertEqual(partners_3.street2, '')
        self.assertEqual(partners_3.city, 'Brussels')
        self.assertEqual(partners_3.city_id.name, 'Brussels')
        self.assertFalse(partners_3.state_id)
        self.assertEqual(partners_3.zip_id.name, '1000')
        self.assertEqual(partners_3.country_id.name, 'Belgium')
        self.assertEqual(partners_3.phone, '')
        self.assertEqual(partners_3.mobile, '')
        self.assertEqual(partners_3.email, '')
        self.assertEqual(partners_3.website, '')
        self.assertEqual(len(partners_3.category_id), 1)
        self.assertEqual(partners_3.category_id.name, 'Partner categ 1')
        self.assertEqual(partners_3.comment, '')
        self.assertEqual(partners_3.agent, False)
        self.assertEqual(partners_3.agent_type, 'agent')
        self.assertEqual(partners_3.settlement, 'monthly')
        self.assertFalse(partners_3.user_id)
        self.assertFalse(
            partners_3.sale_invoicing_grouping_criteria_id.exists())
        self.assertEqual(partners_3.ref, '')
    ...
    def test_import_create_with_sale_invoicing_grouping_criteria_id(self):
        fname = self.get_sample(
            'sample_with_sale_invoicing_grouping_criteria_id.xlsx')
        file = base64.b64encode(open(fname, 'rb').read())
        wizard = self.env['import.file'].create({
            'template_id': self.env.ref(
                'import_template_partner.template_partner').id,
        ...
        self.assertIn(_(
            '4: Contact Customer 1 not found.'), wizard.line_ids[1].name)
        self.assertIn(_(
            '5: Sales Invoicing Grouping Criteria By sale date not found.'),
            wizard.line_ids[2].name)
        partners_1 = self.env['res.partner'].search([
            ('name', '=', 'Customer 1'),
        ])
        ...
        self.assertEqual(partners_1.user_id.name, 'Mitchell Admin')
        self.assertEqual(
            len(partners_1.sale_invoicing_grouping_criteria_id), 1)
        self.assertEqual(
            partners_1.sale_invoicing_grouping_criteria_id.name, 'By partner')
        self.assertEqual(partners_1.ref, 'Ref 1')
        partners_1_1 = self.env['res.partner'].search([
            ('name', '=', 'Contact 1'),
            ('parent_id', '=', partners_1.id),
        ...
        self.assertEqual(partners_3.email, '')
        self.assertEqual(partners_3.website, '')
        self.assertEqual(len(partners_3.category_id), 0)
        self.assertEqual(partners_3.comment, '')
        self.assertEqual(partners_3.agent, False)
        self.assertEqual(partners_3.agent_type, 'agent')
        self.assertEqual(partners_3.settlement, 'monthly')
    ...
    def test_import_write_with_sale_invoicing_grouping_criteria_id(self):
        self.env['res.partner'].create({
            'name': 'Customer 1',
            'company_type': 'company',
        })
    ...
    def test_import_create_with_payment_term_id(self):
        ...
        self.assertEqual(wizard.total_warn, 2)
        self.assertEqual(wizard.total_error, 4)
        self.assertIn(_(
            '3: Contact Customer 1 not found.'), wizard.line_ids[0].name)
        self.assertIn(_(
            '4: Contact Customer 1 not found.'), wizard.line_ids[1].name)
        ...
        self.assertEqual(partners_1.settlement, 'monthly')
        self.assertEqual(partners_1.user_id.name, 'Mitchell Admin')
        self.assertEqual(len(partners_1.property_payment_term_id), 1)
        self.assertEqual(
            partners_1.property_payment_term_id.name, 'Immediate Payment')
        self.assertEqual(len(partners_1.property_supplier_payment_term_id), 1)
        self.assertEqual(
    ...
    def test_import_create_with_discount(self):
        ...
        self.assertEqual(partners_1.settlement, 'monthly')
        self.assertEqual(partners_1.user_id.name, 'Mitchell Admin')
        self.assertEqual(partners_1.default_supplierinfo_discount, 10.0)
        self.assertEqual(partners_1.ref, 'Ref 1')
        partners_1_1 = self.env['res.partner'].search([
            ('name', '=', 'Contact 1'),
            ('parent_id', '=', partners_1.id),
        ...
        self.assertEqual(partners_2.settlement, 'monthly')
        self.assertFalse(partners_2.user_id)
        self.assertEqual(partners_2.default_supplierinfo_discount, -5)
        self.assertEqual(partners_2.ref, '')
        partners_3 = self.env['res.partner'].search([
            ('name', '=', 'Customer 3'),
        ])
        ...
        self.assertEqual(partners_3.settlement, 'monthly')
        self.assertFalse(partners_3.user_id)
        self.assertEqual(partners_3.default_supplierinfo_discount, 0)
        self.assertEqual(partners_3.ref, '')
    ...
    def test_import_create_with_credit_control(self):
        ...
        self.assertEqual(partners_1.payment_note, 'Payment note test')
        self.assertEqual(partners_1.payment_next_action, 'Next action test')
        self.assertEqual(
    ...
    def test_import_create_with_commission(self):
        ...
        self.assertIn(_(
            '4: Contact Customer 1 not found.'), wizard.line_ids[1].name)
        self.assertIn(_(
            '5: Commission Other commission not found.'),
            wizard.line_ids[2].name)
        partners_1 = self.env['res.partner'].search([
            ('name', '=', 'Customer 1'),
        ])
        ...
        self.assertEqual(partners_1.agent, False)
        self.assertEqual(partners_1.agent_type, 'agent')
        self.assertEqual(partners_1.commission_id.name, 'Test commission 10%')
        self.assertEqual(partners_1.settlement, 'monthly')
        self.assertEqual(partners_1.user_id.name, 'Mitchell Admin')
        self.assertEqual(partners_1.ref, 'Ref 1')
        partners_1_1 = self.env['res.partner'].search([
        ...
        self.assertEqual(partners_3.agent, False)
        self.assertEqual(partners_3.agent_type, 'agent')
        self.assertFalse(partners_3.commission_id)
        self.assertEqual(partners_3.settlement, 'monthly')
        self.assertFalse(partners_3.user_id)
        self.assertEqual(partners_3.ref, '')
    ...
    def test_import_create_required_fields(self):
        ...
        wizard.open_template_form()
        self.assertEqual(wizard.total_rows, 7)
        self.assertEqual(len(wizard.line_ids), 15)
        self.assertEqual(wizard.total_warn, 4)
        self.assertEqual(wizard.total_error, 11)
        self.assertIn(_(
            '3: Contact Customer 1 not found.'), wizard.line_ids[0].name)
        self.assertIn(_(
        ...
        self.assertEqual(len(partners_4), 0)
        agent_1 = self.env['res.partner'].search([
            ('name', '=', 'Agent 1'),
        ])
        self.assertEqual(len(agent_1), 0)
        ...
        self.assertEqual(wizard.total_warn, 4)
        self.assertEqual(wizard.total_error, 8)
        self.assertIn(_(
            '3: Option \'False\' for \'company_type\' does not exist. You '
        ...
        self.assertFalse(agent_1.parent_id.exists())
        self.assertEqual(agent_1.type, False)
        self.assertEqual(agent_1.street, 'Moon, 4')
        self.assertEqual(agent_1.street2, '')
        self.assertEqual(agent_1.city, 'Brussels')
        self.assertEqual(agent_1.city_id.name, 'Brussels')
        self.assertFalse(agent_1.state_id)
    ...
    def test_import_write_required_fields(self):
        ...
        self.assertEqual(len(partners_2), 1)
        self.assertEqual(partners_2.company_type, 'person')
        self.assertEqual(partners_2.comercial, 'Customer Engine')
        self.assertFalse(partners_2.vat, '')
        self.assertEqual(partners_2.parent_id, partners_1)
        self.assertEqual(partners_2.type, 'invoice')
        self.assertEqual(partners_2.street, 'Sun, 33')
        self.assertEqual(partners_2.street2, '')
        self.assertEqual(partners_2.city, '')
    ...
    def test_import_write_wrong_values(self):
        ...
        self.assertEqual(wizard.total_warn, 2)
        self.assertEqual(wizard.total_error, 5)
        self.assertIn(_(
            '2: Option \'False\' for \'company_type\' does not exist. You '
            'must choose a valid value.'), wizard.line_ids[0].name)
        self.assertIn(_(
    ...
    def test_import_partner_with_agent(self):
        ...
        self.assertEqual(len(partner_id.agent_ids), 1)
        agent_1 = self.env['res.partner'].search([
            ('name', '=', 'Agent test 1'),
            ('agent', '=', True),
        ])
        self.assertEqual(partner_id.agent_ids[0].id, agent_1.id)
        partner_id = self.env['res.partner'].search([
            ('name', '=', 'Customer 2'),
        ])
        self.assertEqual(len(partner_id), 1)
        self.assertEqual(len(partner_id.agent_ids), 2)
        agent_2 = self.env['res.partner'].search([
            ('name', '=', 'Agent test 2'),
            ('agent', '=', True),
        ])
        self.assertEqual(partner_id.agent_ids[0].id, agent_1.id)
        self.assertEqual(partner_id.agent_ids[1].id, agent_2.id)
    ...
    def test_import_partner_with_partner_group(self):
        ...
        self.assertEqual(len(partner_id), 1)
        self.assertEqual(len(partner_id.partner_group_id), 1)
        partner_group = self.env['res.partner'].search([
            ('name', '=', 'Test group 1'),
        ])
        self.assertEqual(len(partner_group), 1)
        self.assertEqual(partner_id.partner_group_id.id, partner_group.id)
    ...
    def test_import_partner_check_vat(self):
        ...
        self.assertEqual(len(partners_5), 0)
        partners_6 = self.env['res.partner'].search([
            ('name', '=', 'Customer 4'),
        ])
        self.assertEqual(len(partners_6), 0)
        wizard.action_import_from_simulation()
        self.assertEqual(wizard.total_rows, 6)
        self.assertEqual(len(wizard.line_ids), 4)
        self.assertEqual(wizard.total_warn, 2)
        ...
        self.assertEqual(len(partners_4), 1)
        self.assertFalse(partners_4.vat)
        partners_5 = self.env['res.partner'].search([
            ('name', '=', 'Customer 3'),
        ])
        self.assertEqual(len(partners_5), 1)
        self.assertFalse(partners_5.vat)
        partners_6 = self.env['res.partner'].search([
            ('name', '=', 'Customer 4'),
        ])
        self.assertEqual(len(partners_6), 1)
        self.assertEqual(partners_6.vat, 'BE0477472701')
