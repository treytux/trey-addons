...
class EduAtendanceSheet(models.Model):
    ...
    training_plan_line_id = fields.Many2one(
        ...
        domain="[('teacher_id','=',teacher_id),('state','=','active')]",
        states={
            'ready': [('readonly', True)],
            'ended': [('readonly', True)]},
        required=True,
    ...
    training_plan_id = fields.Many2one(
        related='training_plan_line_id.training_plan_id',
    )
    user_id = fields.Many2one(
        related='training_plan_line_id.user_id',
    )
