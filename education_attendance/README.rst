...
Generador de partes de asistencia
=================================

Desde las líneas de planes formativos se permite generar de forma recurrente partes de asistencia configurando la periodicidad.


Visibilidad para alumnos y tutores
==================================

Los roles de alumnos y tutores podrán ver desde el apartado "Educación > Estudiantes > Administrar ausencias" las faltas de asistencia que tengan.
