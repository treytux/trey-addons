...
class TestStockDropshippingFix(common.TransactionCase):
    ...
    def test_sale_purchase_dropshipping(self):
        ...
        self.assertNotEquals(purchase_picking.partner_id, purchase.partner_id)
        self.assertEquals(purchase_picking.partner_id, sale.partner_id)
        self.assertEquals(purchase_picking.supplier_id, purchase.partner_id)
