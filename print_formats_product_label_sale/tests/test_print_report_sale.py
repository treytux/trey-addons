...
class TestPrintProductLabelReportSale(common.TransactionCase):

    def setUp(self):
        super(TestPrintProductLabelReportSale, self).setUp()
    ...
    def test_print_product_label_salereport(self):
        instance_path = os.path.join(
            tools.config['test_report_directory'],
            'test_print_formats_product_label_sale.pdf')
        self.print_report(
