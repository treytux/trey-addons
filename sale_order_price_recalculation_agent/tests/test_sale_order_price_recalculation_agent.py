...
class TestSaleOrderPriceRecalculationAgent(common.TransactionCase):

    def setUp(self):
        super(TestSaleOrderPriceRecalculationAgent, self).setUp()
    ...
    def test_sale_order_price_recalculation_agent(self):
        self.assertEqual(self.order_line_01.agents[0].agent, self.agent_01)
        self.assertRaises(Exception, self.order_01.recalculate_prices())
