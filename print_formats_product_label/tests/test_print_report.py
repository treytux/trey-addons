...
class TestPrintProductLabelReport(common.TransactionCase):

    def setUp(self):
        super(TestPrintProductLabelReport, self).setUp()
    ...
    def test_print_product_label_report(self):
        instance_path = os.path.join(
            tools.config['test_report_directory'],
            'test_print_formats_product_label.pdf')
        self.print_report(
