...
class TestAnalyticAccount(SavepointCase):
    ...
    def test_analytic_account(self):
        """ Test if employee product price is moved to analytic line """
        ...
        timesheet = self.task.timesheet_ids
        self.assertEqual(order_line.analytic_line_ids, timesheet)
