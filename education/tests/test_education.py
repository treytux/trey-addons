...
class TestEnrollment(TestBase):
    ...
    def test_active(self):
        ...
        self.assertEquals(self.enrollment_01.state, 'draft')
        self.classroom_01.student_limit = 1
        self.enrollment_01.to_active()
        self.assertEquals(self.enrollment_01.state, 'active')
    ...
    def test_cancelled(self):
        ...
        self.assertEquals(self.enrollment_01.state, 'cancelled')
    ...
    def test_onchange_student_id(self):
        ...
        self.enrollment_01._onchange_student_id()
        self.assertEquals(self.enrollment_01.tutor_ids, self.student.tutor_ids)
    ...
    def test_onchange_training_plan_id(self):
        ...
        self.assertEquals(self.enrollment_01.comments, 'Lorem ipsum')
    ...
    def test_education_maks_evaluation_lines_mark_tacking(self):
        ...
        self.assertEquals(len(bulletin.message_ids), 2)
        with self.assertRaises(ValidationError):
            bulletin.evaluation_line_ids[1].write({'mark': 'PA'})
        bulletin.evaluation_line_ids[1].mark = 5
        self.assertEquals(len(bulletin.message_ids), 4)
        self.assertIn(
