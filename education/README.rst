...
Ejemplo: "1º A" para el plan formativo "1º ESO 2024/2025"
...
Ejemplo: dentro del plan formativo "1º ESO 2024/2025", hacemos uso de los ejemplos anteriores y creamos una línea que contiene "Matemáticas" / "Pedro Jiménez" / "1º A"
...
Antes de crear la matrícula, es conveniente dar de alta al alumno, si no estuviera dado de alta previamente. Para ello, se puede hacer desde dentro de la propia matrícula o bien desde el menú "Educación > Estudiantes > Estudiantes". Es importante que el alumno tenga marcado "Estudiante" en el apartado de "Venta y Compra" para que se considere que es un estudiante.

A parte del alumno, es posible seleccionar los tutores del estudiante. Son considerados tutores los padres o tutores legales del alumno. Los tutores se pueden crear desde la ficha del estudiante, apartado "Tutores" o bien desde el apartado "Educación > Estudiantes > Tutores". En este caso, es importante indicar en el apartado de "Venta y Compra" que es un tutor y en el apartado "Estudiantes" seleccionar el alumno o alumnos que están a su cargo.
...
Cuando un alumno tiene matriculas correctamente asignada y en estado 'Activa' y 'Finalizada', se pueden generar boletines de notas de dos formas distintas:

- Desde el menú "Educación > "Boletines de notas" > Nuevo registro

Creará un registro individual solicitando el alumno y la matrícula para la que queremos general el boletín de notas.

- Desde la ficha de la línea del plan formativo, pulsando en 'Acción' > Generar boletines

Generará todos los boletines de notas para los alumnos correctamente matriculados en este plan formativo, con sus respectivas evaluaciones, si algún alumno tuviera ya generado un boletín, se completarán las asignaturas/evaluaciones faltantes.

Los boletines tienen su propio informe para imprimir en pdf, que incluye la información visible en el boletín, los datos del alumno, matricula, y distintas asignaturas con las evaluaciones.

.. image:: education/static/description/boletin.png
