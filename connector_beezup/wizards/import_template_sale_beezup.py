...
class ImportTemplateSaleBeezup(models.TransientModel):
    ...
    def get_fiscal_position(self, df, index):
        ...
        warns = []
        if (
                self.force_partner and self.parent_partner_id
    ...
    def process_order(self, order, row_indexs):
        warns = []
        invoice_policy = list(set(order.order_line.filtered(
    ...
    def import_file(self, simulation=True):
        ...
        wizard.dataframe_required_columns(
            df, [
                ...
                'OrderItem_MerchantImportedProductId', 'OrderItem_Title',
                'OrderItem_ItemPrice', 'OrderItem_Shipping_Price',
