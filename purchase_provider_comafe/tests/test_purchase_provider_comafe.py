...
class TestPurchaseProviderComafe(common.TransactionCase):
    ...
    def check_comafe_data_prices(self, connector):
        if not connector.prices_data_comafe:
            self.skipTest('Without Comafe prices data')
        return True
    ...
    def assert_comafe_margin(self, line, expected_margin):
        line.sale_line_id.purchase_price = line.price_unit_comafe
        self.assertAlmostEqual(
            line.sale_line_id.margin_percent * 100, expected_margin, places=2)

    def test_connector_comafe_purchase_only_stock_01(self):
        self.check_credentials()
        self.check_comafe_data_prices(self.connector)
    ...
    def test_connector_comafe_sale_only_stock_01(self):
        ...
        self.assertTrue(line_01.qty_available_comafe > 0)
        self.assertTrue(line_02.qty_available_comafe > 0)
        self.assertEqual(line_01.price_unit_comafe, 2.16)
        self.assertEqual(line_02.price_unit_comafe, 0)
        self.assertEqual(line_01.total_price_comafe, 21.6)
        self.assertEqual(line_02.total_price_comafe, 0)
        self.assertEqual(
            line_01.msg_comafe, 'Rate and stock obtained by API Comafe')
        self.assertEqual(line_02.msg_comafe, 'Stock obtained by API Comafe')
        ...
        self.assertIn(
            'Prices simulated with supplier connector',
            sale.message_ids[0].preview)

    def test_connector_comafe_sale_stock(self):
        self.check_credentials()
        self.supplierinfo_01.product_code = '127837'
        self.supplierinfo_02.product_code = '127843'
        sale = self.create_sale_order(self.product_01, self.product_02)
    ...
    def test_connector_comafe_sale_all_stock_cases_03(self):
        ...
        self.supplierinfo_02.product_code = '106087'
        sale = self.create_sale_order(self.product_01, self.product_02)
        sale.order_line[0].product_uom_qty = 1
        sale.write({
            'order_line': [
                (0, 0, {
                    'product_id': product_03.id,
        ...
        line_02 = wizard.lines[1]
        line_03 = wizard.lines[2]
        self.assertIn('not found in api response', line_01.msg_comafe)
        self.assertEqual(line_02.msg_comafe, 'Stock obtained by API Comafe')
        self.assertEqual(line_03.msg_comafe, 'Stock obtained by API Comafe')
    ...
    def test_connector_comafe_not_supplierinfo_05(self):
        ...
        self.assertEqual(
            wizard.lines[0].msg_comafe, 'Rate and stock obtained by API Comafe')
    ...
    def test_connector_comafe_margin_sale(self):
        ...
        self.assert_comafe_margin(line_01, margin_01)
        self.assert_comafe_margin(line_02, margin_02)
    ...
    def test_connector_comafe_margin_sale_onchange(self):
        ...
        line_01.sale_line_id.price_unit = line_01.price_unit
        line_02.sale_line_id.price_unit = line_02.price_unit
        changed_margin_01 = (1 - (
            line_01.price_unit_comafe / line_01.sale_line_id.price_unit)) * 100
        changed_margin_02 = (1 - (
            line_02.price_unit_comafe / line_02.sale_line_id.price_unit)) * 100
        self.assert_comafe_margin(line_01, changed_margin_01)
        self.assert_comafe_margin(line_02, changed_margin_02)
        self.assertEqual(line_01.sale_line_id.margin_percent * 100, margin_01)
        self.assertEqual(line_02.sale_line_id.margin_percent * 100, margin_02)
