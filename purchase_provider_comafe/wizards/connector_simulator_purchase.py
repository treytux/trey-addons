...
class ConnectorSimulatorPurchase(models.TransientModel):
        ...
        for line in self.lines:
            ...
            if item_price:
                line.write({
                    ...
                    'total_price_comafe': item_price * line.product_qty,
    ...
    def action_to_step_done(self):
        ...
        for line in self.lines.filtered(
            ...
            line.purchase_line_id.price_unit = line.price_unit_comafe
        msg = _('Prices updated with supplier connector')
...
class ConnectorSimulatorPurchaseLine(models.TransientModel):
    ...
    price_unit_comafe = fields.Float(
        string='Price unit Comafe',
        digits=dp.get_precision('Product Price'),
    )
    total_price_comafe = fields.Float(
        string='Total cost Comafe',
    )
    ...
    price_fetch_error_comafe = fields.Boolean(
        string='Price fetch error Comafe',
        default=True,
    )
