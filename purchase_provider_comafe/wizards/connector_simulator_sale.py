...
class ConnectorSimulatorSale(models.TransientModel):
    ...
    def action_to_step_2(self):
        ...
        prices_dict = (
            connector.prices_data_comafe
            and json.loads(connector.prices_data_comafe) or {})
        packs_dict = (
            connector.packaging_data_comafe
            and json.loads(connector.packaging_data_comafe) or {})
    ...
    def _compute_line_color(self):
        ...
        for line in self:
            ...
            if line.multiple_qty_comafe <= line.qty_available_comafe:
                line.line_color = (
                    'green' if line.product_uom_qty % line.packaging_comafe == 0
                    else 'blue')
            else:
                line.line_color = 'orange'
        return res
