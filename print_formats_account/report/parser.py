...
class ReportAccountReportInvoiceBase(models.AbstractModel):
    ...
    def get_lines_grouped_by_sale(self, invoice):
        ...
        return self._group_lines(lines, lambda l: (
            l.sale_line_ids and l.sale_line_ids[0].order_id or None))
    ...
    def get_lines_grouped_by_purchase(self, invoice):
        lines = invoice.invoice_line_ids.sorted(self._sort_line_purhase)
        return self._group_lines(lines, lambda l: (
            l.purchase_line_id and l.purchase_line_id.order_id or None))
