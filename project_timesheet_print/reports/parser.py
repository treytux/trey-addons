...
class ProjectTimesheetReport(models.TransientModel):
    _name = 'report.project_timesheet_print.report_project_timesheet'
    ...
    def render_html(self, data=None):
        ...
        report = report_obj._get_report_from_name(
            'project_timesheet_print.report_project_timesheet')
        ...
        return report.render(
            'project_timesheet_print.report_project_timesheet', docargs)
