(function () {
    ...
    openerp.wspa_order_places = {
        ...
        init: function(){
            ...
            openerp.wspa_order_places.order_select( 'select[name="shipping_country_id"]' );
            openerp.wspa_order_places.order_select( 'select[name="shipping_state_id"]' );
        },
    ...
    $(document).ready(function () {
        ...
        $('select[name="shipping_country_id"]').on('change', function(){
            $('select[name="shipping_state_id"]').val('');
        });
    });
